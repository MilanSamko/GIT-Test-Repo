...
Verify count of loaded tasks
    ...
    ${original_sel_ListItemMyTasks}     Set Variable     xpath=//div[//button[text()='${NameOfTasksTab}' and @aria-pressed="true"]]//following-sibling::div//input
    ${new_sel_ListItemMyTasks}=   Replace String    ${original_sel_ListItemMyTasks}       NameOfTasksTab   ${NameOfTasksTab}
